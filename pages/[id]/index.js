...
export default function index({ lang }) {
    ...
    const [sourceCode, setSourceCode] = useState(src_code_examples[lang].src_code_mandel_brot);
...
export const getStaticProps = async (context) => {
    return {
        props: {
            lang: context.params.id
        },
    };
};

export const getStaticPaths = async () => {
    const paths = [{ params: { id: "lpython" } }, { params: { id: "lfortran" } }];
    return {
        paths,
        fallback: false,
    };
